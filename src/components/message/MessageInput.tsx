...
const MessageInput = () => {
  return (
    <div
      ...
      className="p-2"
    >
      <div className="flex items-center p-2 border rounded-full bg-white dark:bg-gray-800 shadow-sm w-full ">
        <FaRegSmile className="text-gray-500 dark:text-gray-300 ml-2" />
        <input
          type="text"
          className="flex-grow mx-2 outline-none bg-transparent text-gray-600 dark:text-gray-300"
          placeholder="Message"
        />
